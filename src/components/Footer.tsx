...
const Footer = () => {
  ...
  // URLs réelles ici (ou "" pour masquer)
  const social = [
        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <button
              ...
              className="mt-3 inline-flex items-center gap-2 text-sm text-white/75 hover:text-white transition-colors"
            >
          ...
          <div>
            ...
            <h3 className="mt-6 text-sm font-semibold tracking-wide text-white/90">
              {t.resources}
            </h3>
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li>
          ...
          {/* ✅ Contact compact : 1 seul bloc au lieu de 3 cartes */}
          <div>
            <h3 className="text-sm font-semibold tracking-wide text-white/90">
              {t.contact}
            </h3>
            ...
            <div className="mt-3 rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="space-y-3 text-sm">
                <a
                  ...
                  className="flex items-center justify-between gap-3 text-white/85 hover:text-white transition-colors"
                >
