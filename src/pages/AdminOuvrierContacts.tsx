...
// ✅ IMPORTANT : on NE remet PAS max-w-7xl / mx-auto / px-... ici
// car AdminLayout possède déjà le container principal.
// On garde juste un padding vertical/horizontal léger.
const pagePad = "py-5 sm:py-7";
...
const AdminOuvrierContacts: React.FC = () => {
  ...
  return (
    <div className={cn(shellBg, pagePad)}>
      {/* Header */}
      ...
      <div className="mt-6">
        ...
        <div className="hidden md:block">
          <div className={cn(cardClass, "overflow-hidden")}>
            ...
            {/* ✅ Le wrapper gère le scroll horizontal si vraiment nécessaire,
                mais on limite surtout les colonnes visibles via hidden lg/xl */}
            <div className="w-full overflow-x-auto">
              <table className="w-full table-fixed text-sm">
                <thead className="bg-slate-50/80 text-slate-600">
                  <tr className="border-b border-slate-200/60">
                    <th className="w-[150px] text-left px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colDate}
                    </th>
                    <th className="w-[160px] text-left px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colWorker}
                    </th>
                    <th className="w-[260px] text-left px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colClient}
                    </th>

                    {/* Message : seulement lg+ */}
                    <th className="hidden lg:table-cell text-left px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colMessage}
                    </th>

                    <th className="w-[120px] text-left px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colStatus}
                    </th>

                    {/* Origine : seulement xl+ */}
                    <th className="hidden xl:table-cell w-[120px] text-left px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colOrigin}
                    </th>

                    <th className="w-[160px] text-right px-4 py-3 text-xs font-semibold uppercase tracking-wide">
                      {text.colActions}
                    </th>
                  </tr>
                </thead>
                    ...
                    filtered.map((c) => {
                      ...
                      return (
                        <tr key={c.id} className="hover:bg-slate-50/60 align-top">
                          ...
                          {/* Client + (fallback message sur md) */}
                          <td className="px-4 py-4">
                            ...
                            {/* ✅ Sur md, la colonne Message est cachée => on montre un extrait ici */}
            ...
            <div className="px-4 py-3 border-t border-slate-200/60 bg-white/60 text-xs text-slate-500">
              Responsive : “Message” apparaît à partir de <span className="font-semibold">lg</span> et
              “Origine” à partir de <span className="font-semibold">xl</span>.
            </div>
          </div>
        </div>
      </div>
